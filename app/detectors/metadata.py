...
def get_forensic_metadata_score(exif: dict) -> tuple:
    ...
    # High-bypass policy: treat pro pipelines as mild "human" evidence (common in real photos)
    # even though it can be present in post-processed AI as well.
    ...
    # High-bypass policy: ICC presence is treated as mild "human" evidence.
