...
# In-memory job tracking — NOT safe for multi-instance deployments (use Redis for scale-out)
# Format: {job_id: (asyncio.Future, start_time)}
pending_jobs: Dict[str, tuple] = {}

# Buffers webhook results that arrive before pending_jobs is registered (race condition fix)
