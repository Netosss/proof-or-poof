...
def _make_request(headers: dict, method: str = "POST", path: str = "/v1/analyze",
...
async def test_authenticate_missing_headers(mock_redis):
    from app.core import enterprise_auth as ea
    req = _make_request({"X-FauxLens-Key": "fxl_test_xyz"})
